...
> **⚠️ Status — not built in the running app.** Today the app ships **L2–L4** plus
> the **🪁 Extend** and **🔁 Agent Loop** tabs — there is **no L5 tab**. This brief
> documents the *planned* L5 design (routing to external apps via MCP Apps) for the
> spectrum's story and as a reference for extenders. In the workshop, **L5 is
> delivered as a concept, not a live demo.** If you forked this repo expecting an
> L5 tab, that's why it isn't there — see `EXTENDING.md` to build toward it.
